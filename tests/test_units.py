...
def ____test_plc1():
    # this was an attempt to test an anomoly with some PLCs missing some lines and
    # dulicating others, however it turned out to be caused by getListingLines which
    # interprets partial listings from the pmac (thus the test would require hardware)

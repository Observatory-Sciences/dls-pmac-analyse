    ...
    def compare(self, other, noCompare, pmacName, page, fixfile, unfixfile):
        ...
        for n in range(32):
            ...
            if plc is not None:
                ...
                log.debug("PLC%s, isRunning=%s, shouldBeRunning=%s",
                          n, plc.isRunning, plc.shouldBeRunning)
...
class Pmac(object):
    ...
    def readHardware(self, backupDir, checkPositions, debug, comments, verbose):
        ...
        try:
            ...
            log.warning('Connected to a PMAC via "%s" using port %s.',
                        self.host, self.port)
